...
String searchQuery = "SELECT CONCAT('<a href=\"/ECIS/candidateprofile.jsp?candidateid=', Candidate.Id, '\">view</a>') AS Profile, FirstName, MiddleName, LastName, City, StateId AS State "
		+ "FROM Candidate "
